          ...
          <ul>
            <li className="border-b border-gray-200 last:border-0">
              <Link className="block px-4 py-2 hover:bg-gray-50" to="#0" onClick={() => setDropdownOpen(!dropdownOpen)}>
                <span className="block mb-2 text-sm">
                  📣 <span className="font-medium text-gray-800">Edit your information in a swipe</span> Sint occaecat cupidatat non
            ...
            <li className="border-b border-gray-200 last:border-0">
              <Link className="block px-4 py-2 hover:bg-gray-50" to="#0" onClick={() => setDropdownOpen(!dropdownOpen)}>
                <span className="block mb-2 text-sm">
                  🚀
                  <span className="font-medium text-gray-800">Say goodbye to paper receipts!</span> Sint occaecat cupidatat non proident,
