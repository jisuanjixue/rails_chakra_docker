...
function DateSelect() {
  ...
  return (
    <div className="relative">
      <button
        ref={trigger}
        className="justify-between text-gray-500 bg-white border-gray-200 btn min-w-44 hover:border-gray-300 hover:text-gray-600"
      ...
      >
        <span className="flex items-center">
          <svg className="w-4 h-4 mr-2 text-gray-500 fill-current shrink-0" viewBox="0 0 16 16">
            <path d="M15 2h-2V0h-2v2H9V0H7v2H5V0H3v2H1a1 1 0 00-1 1v12a1 1 0 001 1h14a1 1 0 001-1V3a1 1 0 00-1-1zm-1 12H2V6h12v8z" />
          </svg>
          <span>{options[selected].period}</span>
        </span>
        <svg className="ml-1 text-gray-400 fill-current shrink-0" width="11" height="7" viewBox="0 0 11 7">
