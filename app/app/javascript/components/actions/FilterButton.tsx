...
function FilterButton() {
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className="text-gray-500 bg-white border-gray-200 btn hover:border-gray-300 hover:text-gray-600"
        aria-haspopup="true"
        ...
        <div ref={dropdown}>
          ...
          <div className="px-3 py-2 border-t border-gray-200 bg-gray-50">
            <ul className="flex items-center justify-between">
              <li>
                <button className="text-gray-500 bg-white border-gray-200 btn-xs hover:border-gray-300 hover:text-gray-600">Clear</button>
              </li>
              <li>
                <button className="text-white bg-indigo-500 btn-xs hover:bg-indigo-600" onClick={() => setDropdownOpen(false)} onBlur={() => setDropdownOpen(false)}>Apply</button>
              </li>
            </ul>
          </div>
        </div>
