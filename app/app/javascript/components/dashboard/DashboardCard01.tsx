      ...
      <div className="px-5 pt-5">
        <header className="flex items-start justify-between mb-2">
          ...
          <EditMenu className="relative inline-flex">
            <li>
              <Link className="flex px-3 py-1 text-sm font-medium text-gray-600 hover:text-gray-800" to="#0">Option 1</Link>
            </li>
            <li>
              <Link className="flex px-3 py-1 text-sm font-medium text-gray-600 hover:text-gray-800" to="#0">Option 2</Link>
            </li>
            <li>
        ...
        <div className="mb-1 text-xs font-semibold text-gray-400 uppercase">Sales</div>
